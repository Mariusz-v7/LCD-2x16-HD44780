...
void HD44780_write_4bits(uint8_t bits) {
    ...
    HD44780_output(bits, 1);
    HD44780_output(~bits, 0);
...
void HD44780_start() {
    ...
    //
    HD44780_instr(HD44780_CMD_FUNCTION_SET | HD44780_CMD_FUNCTION_SET_8BIT | HD44780_CMD_FUNCTION_SET_DISPLAY_2_LINES);
